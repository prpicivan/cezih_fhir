...
const config = {
    // Try 9443 for Terminology
    baseUrl: 'https://certws2.cezih.hr:9443/services-router/gateway/terminology-services/api/v1/CodeSystem',
    auth: {
...
async function run() {
    try {
        ...
        console.log('\n--- Step 2: Query CodeSystem on port 9443 ---');
